...
asjQuery(document).ready(function() 
{
	...
	asjQuery('a.dropdown-toggle, .dropdown-menu a').on('touchstart', function(e) 
	{
	 ...
	 asjQuery(".hword h3").each(function(){
	 ...
	 asjQuery(".hword h2").each(function(){
	 ...
	 asjQuery(".body__hword .page_header h1").each(function(){
	 ...
	 asjQuery(".body__hword .item_header h1").each(function(){
	 ...
	 asjQuery(".body__hword .page_header h2").each(function(){
	 ...
	 asjQuery(".body__hword .item_header h2").each(function(){
	 ...
	 asjQuery(".body__hword .page_header h3").each(function(){
	 ...
	 asjQuery(".body__hword .item_header h3").each(function(){
